...
export const RightArrowIcon = ({ nameCss }) => {
   return (
         ...
         <svg width={24} height={24} viewBox="0 0 24 24" role="presentation">
            <g fillRule="evenodd">
               <path
                  ...
                  fill="currentColor"
               />
               <path d="M12 14a1 1 0 01-1-1V8a1 1 0 012 0v5a1 1 0 01-1 1m0 3a1 1 0 010-2 1 1 0 010 2" fill="inherit" />
            </g>
         </svg>
      </div>
   );
