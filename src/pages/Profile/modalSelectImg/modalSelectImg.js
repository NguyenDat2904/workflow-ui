    ...
    return (
        <ModalProfile>
            ...
            <form action="" onSubmit={formick.handleSubmit}>
                ...
                <p>
                    This replaces your current profile picture. Only users who have permission to view your profile
                    picture will see this.
                </p>
                <Link to="">
                ...
                <div className={cx('buttonUploadImg')}>
                    <button
                        className={cx('buttonCancelUpload')}
                        type="button"
                        onClick={() => onclickSeeModalSelectImg(0)}
                    >
                        Cancel
                    </button>
