    ...
    return (
            ...
            <div className={cx('ViewAllListWork')}>
                <p className={cx('headerWorkOn')}>
                    <Link to="/profile">
                        <span className={cx('linkProfile')}>{dataUserProfile.name}</span>
                    </Link>
                    / Worked on
                </p>
                ...
                <div className={cx('WorkOn')}>
                    ...
                    {stylesView === false ? (
                        <TaskMaster dataListWork={resultdataListWork} />
                    ) : (
                            ...
                            <div className={cx('viewWorkSelect')}>
                                <div className={cx('nameProject')}>
                                    ...
                                    <div className={cx('nameProjectRight')}>
                                        ...
                                        <p className={cx('nameUser')}>
                                            Name user :{' '}
                                            <span className={cx('nameUserspan')}>{dataUserProfile.name}</span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className={cx('positionSelect')}>
                                    <div className={cx('select')}>
                                        <select
                                            className={cx('selectNameProject')}
